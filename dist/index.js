...
__export(lib_exports, {
  AggregatedTimeGrid: () => AggregatedTimeGrid,
  TimeGrid: () => TimeGrid,
  useAvailabilityOverlaps: () => useAvailabilityOverlaps
});
...
function useFastMouseenter(distance = 15) {
  ...
  const mousePos = (0, import_react.useRef)(null);
  const lastEl = (0, import_react.useRef)(null);
  const updateEl = (0, import_react.useCallback)((x, y) => {
  ...
  const hook = (0, import_react.useCallback)((enable, e) => {
    setEnabled(enable);
    if (enable && e) {
...
function TimeGridDay({ day, handleMouseDown, handleMouseEnter }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "div",
    {
      ...
      children: [
        day.format("ddd "),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "timegrid-day-number", children: day.format("D") }),
        day.format("MMM")
      ]
    },
...
function TimeGrid({
  ...
  const selectionAction = (0, import_react5.useRef)(null);
  const selectionTarget = (0, import_react5.useRef)(null);
  const fastMouseenter = useFastMouseenter();
  const updateSelection = (0, import_react5.useCallback)((updater) => {
    setSelection((prev) => {
  ...
  const days = (0, import_react5.useMemo)(() => {
    const daysArray = [];
  ...
  const { hours, startHour, finalHour } = (0, import_react5.useMemo)(() => {
  ...
  const toggleTimeCell = (0, import_react5.useCallback)((dateTime) => {
    if (isDisabled(dateTime)) {
      return;
    }
    const isSelected = selectionSet.has(dateTime.valueOf());
  ...
  const handleCellKeyDown = (0, import_react5.useCallback)((e, hour, day) => {
    const dateTime = day.clone().hour(hour.hour()).minute(hour.minute()).second(0).millisecond(0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "timegrid-header", role: "row", children: days.map((day) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          TimeGridDay,
          {
            day,
        ...
        hours.map((hour) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "timegrid-row", role: "row", children: days.map((day) => {
...
var import_isSameOrBefore2 = __toESM(require("dayjs/plugin/isSameOrBefore.js"));
...
function AggregatedTimeGridDay({ day }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "div",
    {
      ...
      children: [
        day.format("ddd "),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "timegrid-day-number", children: day.format("D") }),
        day.format("MMM")
      ]
    },
    `day-${day.format("ddd D")}`
...
function AggregatedTimeGrid({
  ...
  const { hours, startHour, finalHour } = (0, import_react7.useMemo)(() => {
    const start = startDate.clone().hour(earliestStart.hour()).minute(0).second(0).millisecond(0);
    const end = startDate.clone().hour(latestEnd.hour()).minute(0).second(0).millisecond(0);
    const final = startDate.clone().hour(latestEnd.hour()).subtract(1, "hour").minute(0).second(0).millisecond(0);
    const hoursArray = [];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "timegrid-header", role: "row", children: days.map((day) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AggregatedTimeGridDay, { day }, day.format("YYYY-MM-DD"))) }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "timegrid-body", children: hours.map((hour) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "timegrid-row", role: "row", children: days.map((day) => {
          const dateTime = day.clone().hour(hour.hour()).minute(hour.minute()).second(0).millisecond(0);
